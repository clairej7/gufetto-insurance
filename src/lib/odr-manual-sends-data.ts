// Envois ODR HISTORIQUES (docs PDF, avant l'app), avec leurs ENTRÉES → le montant
// de l'historique des envois est recalculé EN LIVE (re-match aux primes actuelles).
// Généré depuis les PDF (ODR SADA LOLA, SADA 24_07/03_08, AXA 24_07/03_08).

export type OdrManualEntry = { adresse: string; numeroContrat: string };
export type OdrManualSend = { key: string; date: string; partner: "AXA" | "GENERALI" | "SADA" | "MILA"; entries: OdrManualEntry[] };

export const ODR_MANUAL_SENDS_DOCS: OdrManualSend[] = [
  {
    "key": "lola",
    "date": "2026-06-30",
    "partner": "SADA",
  ...
  },
  {
    ...
    "entries": [
      {
        "adresse": "2 bis et 2 ter passage de Clichy, 75018 Paris, FRANCE",
        "numeroContrat": "5326142104"
      },
      {
        "adresse": "5 Rue des Sablons, 75016 Paris, FRANCE",
        "numeroContrat": "5281478404"
      },
      {
        "adresse": "52 Rue Henri Dunant, 92700 Colombes, FRANCE",
        "numeroContrat": "7335396304"
      },
      {
        "adresse": "36-38 Rue Jules Guesde, 93220 Gagny, FRANCE",
        "numeroContrat": "7397365504"
      },
      {
        "adresse": "2 Rue d'Alembert, 93100 Montreuil, FRANCE",
        "numeroContrat": "5672429904"
      },
      {
        "adresse": "5 Rue du Ruisseau, 75018 Paris, FRANCE",
        "numeroContrat": "21149007304"
      },
      {
        "adresse": "55 Rue de Strasbourg, 95240 Cormeilles-en-Parisis, FRANCE",
  ...
  },
  {
    ...
    "entries": [
      {
        "adresse": "192 Av. Henri Barbusse, 93700 Drancy",
        "numeroContrat": "10568171904"
      },
      {
        "adresse": "106 Rue du Maréchal Foch, 59120 Loos",
        "numeroContrat": "21934524204"
      },
      {
      ...
      {
        "adresse": "160/162 rue Cardinet & 116 rue Truffaut, 75017 Paris",
