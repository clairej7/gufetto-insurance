...
function buildPrompt(
  ...
  lines.push(
    ...
    "",
    `Notre recommandation : **${recommandeAssureur ?? devis[0]?.assureur ?? "l'offre retenue"}**. <2 à 4 phrases concrètes et chiffrées, basées sur les données ci-dessus : économie ou surcoût vs prime de référence (${formatPrime(basePrime)}), garanties/franchises/plafonds clés qui distinguent cette offre. Si le contrat actuel EXCLUT explicitement des garanties (uniquement celles énoncées dans ses « Points faibles ») que ce devis inclut, mets-le en avant — c'est un argument fort. S'il y a un autre devis reçu, mentionne-le brièvement avec sa prime et conclus en positionnant l'offre retenue comme le meilleur ÉQUILIBRE entre l'étendue des garanties et la maîtrise du coût.>`,
    "",
    ...
    "- Paragraphe recommandation : 2 à 4 phrases maximum, concret et chiffré, uniquement à partir des données réelles ci-dessus.",
    "- ABSENCE/EXCLUSION côté CONTRAT ACTUEL : ne l'affirme JAMAIS sur la base du STATUT de garantie (l'extraction met « non » quand elle ne DÉTECTE pas le détail — ce n'est PAS une preuve d'absence). EXCEPTION AUTORISÉE : tu PEUX dire que le contrat actuel EXCLUT une garantie UNIQUEMENT si ses « Points faibles » ci-dessus l'énoncent EXPLICITEMENT (ex. « Vol et vandalisme exclus »). Dans ce cas c'est un excellent argument, dis-le clairement (« votre contrat actuel exclut X, que ce devis inclut »). HORS de cette exception : présente les garanties du DEVIS comme une couverture complète (« couvre notamment … ») sans sous-entendre qu'elles manqueraient au contrat actuel. Argumente aussi les différences prouvables : prix, franchises, plafonds/LCI chiffrés.",
